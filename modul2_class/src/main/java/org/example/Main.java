...
class Main {
    ...
    void menu() {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    menuStudent(scanner); // Call menu for student with scanner as parameter
                    break;
                case 2:
                    menuAdmin(scanner); // Call menu for admin with scanner as parameter
                    break;
                case 3:
                    System.out.println("Thank you. Exiting program.");
                    System.exit(0);
    ...
    void menuStudent(Scanner scanner) {
        ...
        // Di sini Anda dapat melakukan apa pun yang diperlukan setelah informasi mahasiswa diterima
        System.out.println("Welcome, " + name + "!");
        System.out.println("NIM: " + nim);
        System.out.println("Major: " + major);

        // Implementasikan logika menu untuk mahasiswa di sini
    }
