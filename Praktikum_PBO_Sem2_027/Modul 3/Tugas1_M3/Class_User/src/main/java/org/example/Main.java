...
class LibrarySystem {
    ...
    public static void main(String[] args) {
        bookList.add(new HistoryBook("1", "Komik Naruto", "Wea Boo", "Anime", 10, 7));
        bookList.add(new TextBook("2", "Belajar Java dengan Mudah", "Alex", "Pemrograman", 8, 10));

        userStudents.add(new Student("202310370311147", "Fira", "Teknik", "Informatika"));
        menu();
    }
