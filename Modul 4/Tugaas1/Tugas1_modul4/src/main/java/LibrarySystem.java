package Tuga1.modul4.com.main;

import Tugas1.modul4.data.Admin;
import Tugas1.modul4.data.Student;
...
public class LibrarySystem {
    ...
    public static Tugas1.modul4.books.Book daftarBuku[] = new Tugas1.modul4.books.Book[100]; // array satu dimensi untuk menyimpan buku
    ...
    public static void main(String[] args) {
        daftarBuku[i++] = new Tugas1.modul4.books.StoryBook("SB32F", "Janda Loro ati", 17, "Story", "Martis");
        daftarBuku[i++] = new Tugas1.modul4.books.HistoryBook("HB324", "Satu Hari", 2, "History", "Moskov");
        daftarBuku[i++] = new Tugas1.modul4.books.TextBook("TB323", "Pasutri", 4, "Text", "Eudora");
