...
public class Student extends User implements iMenu {
    ...
    public boolean isStudents(TextField username) throws IllegalAdminAcces {
        if (username.getText().length() != 15) {
            throw new IllegalAdminAcces("NIM harus 15 digit!");
        }
        ...
        throw new IllegalAdminAcces("NIM tidak ditemukan!");
    }
}
